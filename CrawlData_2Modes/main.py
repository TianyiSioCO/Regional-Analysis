...
API_KEY = "2mF0rdaGSTpixNCiZAFrk1CCnIPBFJIljQSfkLKy"  # replace apikey (1 apikey=2000 location pts/day)
EMAIL = "yystoreyyback@gmail.com"  # replace with a non-primary email address!! (The download and extraction process is fully automatic, and email is used for notification.)
...
def main():
    input_data = {
        'attributes': 'air_temperature,alpha,aod,asymmetry,clearsky_dhi,clearsky_dni,clearsky_ghi,cloud_fill_flag,cloud_type,dew_point,dhi,dni,fill_flag,ghi,ozone,relative_humidity,solar_zenith_angle,ssa,surface_albedo,surface_pressure,tmy_year,total_precipitable_water,wind_direction,wind_speed',
        'interval': '60',
